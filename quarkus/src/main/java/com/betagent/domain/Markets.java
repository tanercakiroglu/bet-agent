...
public final class Markets {
    ...
    public static final Map<String, Set<String>> CANDIDATE_OUTCOMES = Map.of(
            "HTFT", Set.of("1/2", "2/1", "1/X", "2/X"),
            "FIRST_HALF_1X2", Set.of("1", "X", "2"),
            "FIRST_HALF_KG_TARAF", Set.of("KG_VAR_1", "KG_VAR_X", "KG_VAR_2"),
            "FIRST_HALF_BTTS", Set.of("VAR"));
